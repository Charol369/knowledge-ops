...
1. Keep status documents aligned with real command output: `112 passed`, P0 intent regression 5/5, Docker Compose local Langfuse trace/score smoke, external interface smoke artifact, and 20-case hybrid `1.0` retrieval result.
